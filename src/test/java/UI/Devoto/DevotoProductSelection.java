...
public class DevotoProductSelection extends BaseUITest {

    public DevotoProductSelection(WebDriver remoteDriver){
        driver = remoteDriver;
    }
    ...
    public DevotoCheckoutCart  checkoutCart() {
        driver.findElement(By.id("btn-finalizar-compra")).click();
        DevotoCheckoutCart nextPage = new DevotoCheckoutCart(driver);
        return nextPage;
    }
}
